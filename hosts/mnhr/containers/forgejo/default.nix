...
in {
  options.services.forgejo-compose = {
    enable = mkEnableOption "Forgejo Docker Compose service";

    domain = mkOption {
      type = types.str;
      default = "forgejo.homeworld.lan";
      description = "Domain name for the Forgejo service";
    };
